...
class lab105(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab105", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab105")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab105")
        ...
        self.connect((self.digital_pfb_clock_sync_xxx_0, 0), (self.blocks_exponentiate_const_cci_0, 0))
    ...
    def set_sample_rate(self, sample_rate):
        ...
        self.qtgui_sink_x_0_0.set_frequency_range(0, self.sample_rate)
...
def main(top_block_cls=lab105, options=None):
