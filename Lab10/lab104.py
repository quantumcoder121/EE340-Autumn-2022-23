...
class lab104(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab104", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab104")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab104")
        ...
        self.blocks_vco_c_0 = blocks.vco_c(sample_rate, -5, 1)
        ...
        self.connect((self.blocks_add_const_vxx_0_0, 0), (self.blocks_multiply_xx_1_0, 0))
...
def main(top_block_cls=lab104, options=None):
