...
class lab102(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab102", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab102")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab102")
...
def main(top_block_cls=lab102, options=None):
