...
class lab109(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab109", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab109")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab109")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'received_diff_qpsk.txt', False)
        ...
        self.analog_sig_source_x_0_0_1 = analog.sig_source_f(2000000, analog.GR_SIN_WAVE, 100000, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0_0_1, 0), (self.blocks_multiply_const_vxx_1_0, 0))
        ...
        self.connect((self.blocks_add_xx_0_0, 0), (self.blocks_multiply_xx_0_0_1, 0))
        ...
        self.connect((self.blocks_complex_to_float_1, 1), (self.blocks_threshold_ff_0, 0))
        self.connect((self.blocks_complex_to_float_1, 0), (self.blocks_threshold_ff_0_0, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_1_0, 0), (self.blocks_multiply_xx_0_0_1, 1))
        ...
        self.connect((self.blocks_multiply_xx_0_0_1, 0), (self.low_pass_filter_0_1, 0))
        ...
        self.connect((self.blocks_threshold_ff_0, 0), (self.blocks_add_xx_0, 1))
        ...
        self.connect((self.fir_filter_xxx_0, 0), (self.blocks_complex_to_float_1, 0))
        ...
        self.connect((self.low_pass_filter_0_1, 0), (self.blocks_float_to_complex_0, 1))
...
def main(top_block_cls=lab109, options=None):
