...
class midsem(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "midsem", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("midsem")
        ...
        self.settings = Qt.QSettings("GNU Radio", "midsem")
        ...
        self.delay0 = delay0 = 0

        ##################################################
        # Blocks
        ##################################################
        self._delay1_range = Range(-3.5, 3.5, 0.01, 0, 200)
        self._delay1_win = RangeWidget(self._delay1_range, self.set_delay1, "delay1", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.hilbert_fc_1 = filter.hilbert_fc(6400, window.WIN_HAMMING, 6.76)
        self.hilbert_fc_0 = filter.hilbert_fc(6400, window.WIN_HAMMING, 6.76)
        self._delay0_range = Range(-180, 180, 1, 0, 200)
        self._delay0_win = RangeWidget(self._delay0_range, self.set_delay0, "delay0", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._delay0_win)
        self.blocks_throttle_1 = blocks.throttle(gr.sizeof_float*1, samp_rate,True)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*1, samp_rate,True)
        self.blocks_multiply_xx_0_0 = blocks.multiply_vff(1)
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(-1)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, 'Double_SSB.dat', True, 0, 0)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 100000, 1, 0, delay1)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 100000, 1, 0, delay1)
        ...
        self.connect((self.analog_sig_source_x_0_0, 0), (self.qtgui_time_sink_x_1_0, 0))
        ...
        self.connect((self.blocks_complex_to_imag_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.blocks_complex_to_real_0, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.blocks_complex_to_real_0, 0), (self.blocks_add_xx_0_0, 0))
        ...
        self.connect((self.blocks_file_source_0, 0), (self.qtgui_time_sink_x_1_1, 0))
    ...
    def set_delay1(self, delay1):
        self.delay1 = delay1
        self.analog_sig_source_x_0.set_phase(self.delay1)
        self.analog_sig_source_x_0_0.set_phase(self.delay1)

    def get_delay0(self):
        return self.delay0

    def set_delay0(self, delay0):
        self.delay0 = delay0




def main(top_block_cls=midsem, options=None):
