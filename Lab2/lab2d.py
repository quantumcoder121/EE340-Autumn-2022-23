...
class lab2d(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab2d", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab2d")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab2d")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, 'data1.dat', True, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 6000, 1, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_1.set_taps(firdes.low_pass(1, self.samp_rate, 6000, 1, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=lab2d, options=None):
