...
class lab2a(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab2a", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab2a")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab2a")
        ...
        self.connect((self.blocks_abs_xx_0, 0), (self.qtgui_time_sink_x_1_1, 0))
        ...
        self.connect((self.low_pass_filter_0, 0), (self.blocks_throttle_0_0, 0))
...
def main(top_block_cls=lab2a, options=None):
