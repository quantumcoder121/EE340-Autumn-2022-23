...
class lab2b(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab2b", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab2b")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab2b")
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1000, self.samp_rate, 10000, 1000, window.WIN_RECTANGULAR, 6.76))
...
def main(top_block_cls=lab2b, options=None):
