...
class lab2c(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab2c", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab2c")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab2c")
        ...
        self.low_pass_filter_0 = filter.interp_fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_RECTANGULAR,
                6.76))
        self.hilbert_fc_0 = filter.hilbert_fc(6500, window.WIN_HAMMING, 6.76)
        ...
        self.analog_sig_source_x_1_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 200000, 1, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 200000, 1, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 200000, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 200000, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_2, 0), (self.hilbert_fc_0, 0))
        ...
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_throttle_2, 0))
        ...
        self.connect((self.blocks_throttle_1, 0), (self.qtgui_freq_sink_x_1, 0))
        self.connect((self.blocks_throttle_1, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.blocks_throttle_2, 0), (self.qtgui_freq_sink_x_0, 0))
        ...
        self.connect((self.low_pass_filter_1, 0), (self.blocks_throttle_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_1.set_taps(firdes.low_pass(1, self.samp_rate, 22000, 1000, window.WIN_RECTANGULAR, 6.76))
...
def main(top_block_cls=lab2c, options=None):
