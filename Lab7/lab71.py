...
class lab71(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab71", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab71")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab71")
        ...
        self.connect((self.digital_chunks_to_symbols_xx_0, 0), (self.qtgui_sink_x_1, 0))
    ...
    def set_symbol_rate(self, symbol_rate):
        ...
        self.qtgui_eye_sink_x_0.set_samp_rate(self.symbol_rate*self.samples_per_symbol)
...
def main(top_block_cls=lab71, options=None):
