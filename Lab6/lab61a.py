...
class lab61a(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab61a", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab61a")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab61a")
        ...
        # Blocks
        ##################################################
        self._amp_range = Range(0, 1, 0.00001, 0.001, 200)
        ...
        self.blocks_multiply_const_vxx_0_1 = blocks.multiply_const_ff(amp)
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_ff(0.9)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(-0.2)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, 'Input.bin', True, 0, 0)
        ...
        self.connect((self.blocks_file_source_0, 0), (self.blocks_multiply_const_vxx_0_1, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_0_1, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_transcendental_0, 0), (self.blocks_multiply_const_vxx_0_0, 0))
...
def main(top_block_cls=lab61a, options=None):
