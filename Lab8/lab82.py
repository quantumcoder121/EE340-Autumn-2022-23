...
class lab82(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab82", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab82")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab82")
        ...
        self.blocks_threshold_ff_0 = blocks.threshold_ff(-0.025, 0.025, 0)
        ...
        self.connect((self.low_pass_filter_0, 0), (self.root_raised_cosine_filter_0_0, 0))
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.root_raised_cosine_filter_0.set_taps(firdes.root_raised_cosine(1, self.sym_rate*self.sps, self.sym_rate, self.alpha, 11*self.sps))
        self.root_raised_cosine_filter_0_0.set_taps(firdes.root_raised_cosine(1, 2000000, 2000000/self.sps, self.alpha, 11*self.sps))
...
def main(top_block_cls=lab82, options=None):
