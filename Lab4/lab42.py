...
class lab42(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab4_2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab4_2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab42")
    ...
    def set_quad_rate(self, quad_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1.0, self.quad_rate, 12000, 1000, window.WIN_RECTANGULAR, 6.76))
...
def main(top_block_cls=lab42, options=None):
