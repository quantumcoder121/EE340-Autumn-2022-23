...
class lab41(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab4_1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab4_1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab41")
    ...
    def set_quad_rate(self, quad_rate):
        ...
        self.qtgui_time_sink_x_0.set_samp_rate(self.quad_rate)
...
def main(top_block_cls=lab41, options=None):
