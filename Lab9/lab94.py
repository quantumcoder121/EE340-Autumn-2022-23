...
class lab94(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab94", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab94")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab94")
        ...
        self.low_pass_filter_0 = filter.interp_fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(10, 0.062831853, firdes.root_raised_cosine(750, 3200000, 10000, 0.5, 110), 32, 16, 1.5, 1)
        ...
        self.blocks_multiply_const_vxx_0_0_1 = blocks.multiply_const_cc(-0.5)
        self.blocks_multiply_const_vxx_0_0_0 = blocks.multiply_const_cc(-0.5)
        ...
        self.blocks_delay_0_0_2 = blocks.delay(gr.sizeof_gr_complex*1, 1)
        self.blocks_delay_0_0_1 = blocks.delay(gr.sizeof_gr_complex*1, 1)
        ...
        self.blocks_add_xx_5 = blocks.add_vcc(1)
...
def main(top_block_cls=lab94, options=None):
