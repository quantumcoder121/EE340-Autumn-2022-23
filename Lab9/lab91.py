...
class lab91(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab91", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab91")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab91")
        ...
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, 256000,True)
...
def main(top_block_cls=lab91, options=None):
