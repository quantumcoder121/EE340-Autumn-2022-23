...
class lab92(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab92", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab92")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab92")
        ...
        self.low_pass_filter_0 = filter.interp_fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.interp_fir_filter_xxx_0 = filter.interp_fir_filter_ccc(10, [1])
        ...
        self.connect((self.fir_filter_xxx_0, 0), (self.blocks_add_xx_1, 1))
...
def main(top_block_cls=lab92, options=None):
