...
class lab1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self.blocks_vector_source_x_0 = blocks.vector_source_f((262, 262, 294, 262, 349, 330, 262, 262, 294, 262, 392, 349, 262, 262, 277, 440, 392, 349, 330, 466, 466, 440, 349, 392, 349), True, 1, [])
        self.blocks_vco_f_0 = blocks.vco_f(32000, 6.283, 1)
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_float*1, 12000)
