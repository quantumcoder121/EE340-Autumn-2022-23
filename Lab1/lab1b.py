...
class lab1b(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab1b", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab1b")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab1b")
        ...
        self.rational_resampler_xxx_0_0 = filter.rational_resampler_fff(
                ...
                taps=[],
                fractional_bw=0)
        self.blocks_wavfile_source_1 = blocks.wavfile_source('vocal.wav', True)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('background.wav', True)
...
def main(top_block_cls=lab1b, options=None):
